--source: https://wiki.haskell.org/Library_for_colours
--this module serves as interface to the Fast_PPM module to write the 
--result of my raytracing algorithm into a ppm file
module Colour where
